...
\usepackage[backend=biber,style=numeric-comp,sorting=none,isbn=false,url=false,doi=true]{biblatex}
...
\newcommand\uptag[1]{\textsuperscript{\textit{\@alph{#1}}}}
%\newcommand\uptag[1]{\textsuperscript{\@fnsymbol{#1}}}
\makeatother%

\newcommand{\xinvestigator}[2][]{
  \author[#1]{#2}
  \appto\xinvestigators{#2\uptag{#1}\par}
}

\newcommand{\xaffiliation}[2][]{
  \affil[#1]{#2}
  \appto\xaffiliations{#2\uptag{#1}\par}
}
...
\captionsetup[ruled]{labelfont=rm,labelsep=colon,strut=off}
\captionsetup{format=plain,labelformat=simple,labelsep=colon,justification=raggedright}
...
\chapter*{List of Acronyms}\label{chp:Aacronyms}
