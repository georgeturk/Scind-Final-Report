...
\begin{figure}
  ...
  \centering%
  \subbottom[]{
    \includegraphics[width=0.18\textwidth]{simulation/tet_cut1}
    \label{fig:tet_cut1}
  }\hfill%
  \subbottom[]{
    \includegraphics[width=0.18\textwidth]{simulation/tet_cut2}
    \label{fig:tet_cut2}
  }\hfill%
  \subbottom[]{
    \includegraphics[width=0.18\textwidth]{simulation/tet_cut3}
    \label{fig:tet_cut3}
  }\hfill%
  \subbottom[]{
    \includegraphics[width=0.18\textwidth]{simulation/tet_cut4}
    \label{fig:tet_cut4}
  }\hfill%
  \subbottom[]{
    \includegraphics[width=0.18\textwidth]{simulation/tet_cut5}
    \label{fig:tet_cut5}
  }
...
\begin{figure}
  \centering%
  \includegraphics[width=0.3\textwidth]{simulation/tet_flat1}
  \label{fig:tet_flat1}
  \hspace{10ex}
  \includegraphics[width=0.3\textwidth]{simulation/tet_flat2}
  \label{fig:tet_flat2}
...
\begin{figure}
  \centering%
	\includegraphics[width=0.4\linewidth,frame]{simulation/sphere_1}\hfill%
	\includegraphics[width=0.4\linewidth,frame]{simulation/sphere_2}\\[1.5ex]
	\includegraphics[width=0.4\linewidth,frame]{simulation/sphere_3}\hfill%
	\includegraphics[width=0.4\linewidth,frame]{simulation/sphere_4}\\[1.5ex]
	\includegraphics[width=0.4\linewidth,frame]{simulation/sphere_5}\hfill%
	\includegraphics[width=0.4\linewidth,frame]{simulation/sphere_6}\\
...
\begin{figure}
  \centering
  \includegraphics[frame,width=1.0\textwidth]{simulation/performance_plots.png}
...
\begin{figure}
  ...
  \caption{Comparison of hierarchical matrix and sparse factorization solutions on \acr{gpu}s}
  \label{fig:Htests}
\end{figure}
...
\begin{figure}[ht]
  \centering
  \includegraphics[frame,width=0.99\textwidth]{simulation/defo.pdf}
  \caption{Our novel time-integration scheme \acr{pbdd} can simulate deformable objects such as a ball or a large object with large timesteps for realtime applications}
  \label{fig:pbdd}
\end{figure}
