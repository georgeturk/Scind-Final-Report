...
Below is a list of plots in \autoref{fig:indivSubjs} showing all trials and for all subjects:
...
%\section{\st{Predictive Evaluation}}\label{sec:predictive}

% \textbf{\textcolor{red}{This is here for reference but has to be addressed}}
