...
This aims involves the modeling, texturing, and visualization of \acr{3d} surface and volumetric meshes for procedure-specific surgical tools and tissue/organs. We will focus on modeling robotic tools used in \acr{rarp} with the da Vinci Xi, and tissue/organs that are specific to \acr{rarp} \acr{ut} which include the prostate, the urethra, the bladder, and surrounding tissue.
